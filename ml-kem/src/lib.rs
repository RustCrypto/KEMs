...
use typenum::{U10, U11, U2, U3, U4, U5};
...
pub type Encoded<T> = GenericArray<u8, <T as EncodedSizeUser>::EncodedSize>;
...
pub type SharedKey<K> = GenericArray<u8, <K as KemCore>::SharedKeySize>;

/// A ciphertext produced by the KEM `K`
pub type Ciphertext<K> = GenericArray<u8, <K as KemCore>::CiphertextSize>;
